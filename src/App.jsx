...
function getLevelProgress(xp) {
  ...
  const cur = xp - XP_THRESHOLDS[lvl - 1];
  const need = XP_THRESHOLDS[lvl] - XP_THRESHOLDS[lvl - 1];
      ...
      <div className="slide" onClick={e => e.stopPropagation()} style={{ background: "#0a0a14", border: `1px solid ${color}44`, borderRadius: 12, padding: "24px 20px", width: "100%", maxWidth: 500, maxHeight: "88vh", overflow: "auto", boxShadow: `0 0 40px ${glow}` }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <div>
            ...
            <div style={{ fontSize: 11, color, marginTop: 2 }}>{statName} · 240 Levels · 20 Tiers</div>
          </div>
                ...
                {!isDesktop && (
                  <div className="bp" style={{ background: "linear-gradient(135deg,#0d0d2a,#0a0a18)", border: "1px solid rgba(41,121,255,.25)", borderRadius: 12, padding: "18px 16px", marginBottom: 14, position: "relative", overflow: "hidden", boxShadow: "0 0 28px rgba(41,121,255,.1)" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 14 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <div className="float" style={{ fontSize: 34, lineHeight: 1, filter: "drop-shadow(0 0 8px rgba(41,121,255,.5))" }}>{getCharIcon(ovLvl)}</div>
                        <div>
                          {editName_ ? (
                          ...
                          <button onClick={() => setLevelTable({ xp: 0, color: "#2979ff", glow: "rgba(41,121,255,0.5)", name: "Overall Level" })} style={{ fontFamily: "'Orbitron',monospace", fontSize: 9, color: "#2979ff", letterSpacing: 1.5, marginTop: 2, background: "transparent", border: "none", cursor: "pointer", padding: 0, textDecoration: "underline", textDecorationStyle: "dotted" }}>
                            T{ovTier.tier} · {getCharTitle(ovLvl).toUpperCase()} ↗
                          </button>
                        </div>
                      </div>
                    ...
                    <div style={{ paddingTop: 12, borderTop: "1px solid rgba(255,255,255,.05)" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                        ...
                        <button onClick={() => setLevelTable({ xp: state.statXP.will, color: "#ffd600", glow: "rgba(255,214,0,0.5)", name: "Will" })} style={{ fontFamily: "'Orbitron',monospace", fontSize: 9, color: "#ffd600", letterSpacing: .8, flex: 1, background: "transparent", border: "none", cursor: "pointer", textAlign: "left", padding: 0, textDecoration: "underline", textDecorationStyle: "dotted" }}>
                          WILL — LVL {getLevel(state.statXP.will)} · {getLevelName(getLevel(state.statXP.will))} ↗
                        </button>
                ...
                <div className="fade" style={{ padding: isDesktop ? "30px 36px 0" : "18px 14px 0" }}>
                  ...
                  <div style={{ background: `linear-gradient(135deg,${cfg.color}0e,#0a0a12)`, border: `1px solid ${cfg.color}30`, borderRadius: 12, padding: isDesktop ? "20px" : "16px", marginBottom: 18, boxShadow: `0 0 18px ${cfg.glow}` }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                      ...
                      {isDesktop && (
                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                          <div style={{ fontFamily: "'Orbitron',monospace", fontSize: 24, fontWeight: 900, color: cfg.color, lineHeight: 1 }}>{lvl}</div>
                          <div style={{ fontSize: 8, color: "#333", fontFamily: "'Share Tech Mono',monospace" }}>/240</div>
                        </div>
                      )}
                    </div>
                  ...
                  <div style={{ display: isDesktop ? "grid" : "block", gridTemplateColumns: isDesktop ? "1fr 1fr" : undefined, gap: isDesktop ? 22 : 0, alignItems: "start" }}>
                    ...
                    <div style={{ marginTop: isDesktop ? 0 : 0 }}>
                      ...
                      <div style={{ background: "rgba(255,214,0,.04)", border: "1px solid rgba(255,214,0,.12)", borderRadius: 9, padding: "10px 13px", marginBottom: 14 }}>
                        <div style={{ fontSize: 11, color: "#ffd600", fontFamily: "'Share Tech Mono',monospace", lineHeight: 1.5 }}>🔁 Habits can be logged as many times as you do them.</div>
                      </div>
                          ...
                          {habits.map(habit => {
                            ...
                            return (
                              <div key={habit.id} style={{ background: "#0d0d1a", border: "1px solid rgba(255,214,0,.15)", borderRadius: 10, padding: "14px 15px" }}>
                                ...
                                <button className="habit-btn" onClick={() => logHabit(habit)} style={{ width: "100%", background: "linear-gradient(135deg,rgba(255,214,0,.15),rgba(255,214,0,.25))", border: "1px solid rgba(255,214,0,.4)", color: "#ffd600", borderRadius: 8, padding: "12px", cursor: "pointer", fontFamily: "'Orbitron',monospace", fontSize: 12, fontWeight: 700, letterSpacing: 1, boxShadow: "0 0 12px rgba(255,214,0,.15)", display: "flex", alignItems: "center", justifyContent: "center", gap: 9, transform: isPopping ? "scale(.97)" : "scale(1)" }}>
